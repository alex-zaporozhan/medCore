 ...
 */
export function AdminDrawer({ overlayProps, styles, position = "right", ...rest }: DrawerProps) {
  ...
  return (
    <Drawer position={position} overlayProps={mergedOverlay} styles={mergedStyles} {...rest} />
  );
}
