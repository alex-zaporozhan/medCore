  ...
  return (
    <Stack>
      ...
      <Text size="sm" c="dimmed">
        Настройки применяются к приложению пациента: шапка, кнопки, карточки. Логотип показывается в шапке приложения вместо названия по умолчанию. Один шрифт задаётся для всего приложения (заголовки и текст).
      </Text>
