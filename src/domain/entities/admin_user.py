...
from sqlalchemy import Date, ForeignKey, String, func, text
...
class AdminUser(Base):
    ...
    profession_category_id: Mapped[uuid.UUID | None] = mapped_column(
        ForeignKey("staff_profession_categories.id", ondelete="SET NULL"),
        nullable=True,
        index=True,
    )
