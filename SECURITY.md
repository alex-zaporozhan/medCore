...
Report vulnerabilities privately to **Alexandr Zaporozhan** (`alexandr.zaporojan@gmail.com`). Do not open a public GitHub issue for credential leaks, auth bypass, or tenant isolation bugs.
