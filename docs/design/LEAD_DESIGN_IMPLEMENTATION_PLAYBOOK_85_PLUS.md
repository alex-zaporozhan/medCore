...
> **Основа:** `docs/design/LEAD_DESIGNER_TZ_ENTERPRISE_85_PLUS.md` + результаты `@DESIGN`.  
> **Унификация палитры Swiss Slate / Ink (канон §3.6):** маршрут — **`docs/design/LEAD_DESIGN_UNIFICATION_ROUTE_SWISS_SLATE_INK.md`**.  
> **Каталог:** артефакты `DESIGN_*`, палитры, CSV и HTML — в **`docs/design/`**. Привязка к `frontend/` — **`docs/design/DESIGN_CODE_MAP.md`**.
...
- `DESIGN_COMPONENT_MAPPING.md`
- `DESIGN_P0_P1_BACKLOG.md`
- [STREAM_PRODUCTION_READINESS.md](../architecture/arch_plan/STREAM_PRODUCTION_READINESS.md)
- [PHASE_FULL_CLOSURE_BACKLOG.md](../architecture/arch_plan/PHASE_FULL_CLOSURE_BACKLOG.md)
