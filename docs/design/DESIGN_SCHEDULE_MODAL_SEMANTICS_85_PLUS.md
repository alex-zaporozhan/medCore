...
> **Роль:** @DESIGN  
> **Связь:** `docs/design/DESIGN_TOKENS_85_PLUS.json`, `docs/design/LEAD_DESIGN_IMPLEMENTATION_PLAYBOOK_85_PLUS.md` (Step 4), `docs/design/DESIGN_ENTERPRISE_85_PLUS_CONCEPT.md` §3.6  
...
- Паритет в JSON: `docs/design/DESIGN_TOKENS_85_PLUS.json` → `color.calendar.cardBorder`, `cardShadow`, а также `cssVarCardBorder` / `cssVarCardShadow` (имена CSS-переменных).
