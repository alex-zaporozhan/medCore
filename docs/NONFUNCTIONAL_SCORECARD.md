...
| Security (critical в SCA/образах) | 0 на релизной ветке | pip-audit в CI без игнора; Trivy FS (`security-trivy.yml`); JWT на PyJWT (CONTRIBUTING.md) | 2026-03-24 | 0 critical в слоях образа в реестре — @LEAD | 2026-03-24 |
