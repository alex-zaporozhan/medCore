...
Полная пошаговая инструкция (ошибка `database "dental_booking_test" does not exist`, `DATABASE_URL_TEST`, миграции на тестовую БД): **[development/TEST_DATABASE.md](development/TEST_DATABASE.md)**.
