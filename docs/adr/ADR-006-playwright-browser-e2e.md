...
**Status:** accepted  
**Date:** 2026-03-21  
**Context:** запрос @QA_ARCH на фиксацию инструмента и контура CI; связь с `docs/artifacts/ARCH_QA_BROWSER_E2E_ENTERPRISE.md` и `ARCH_QA_BROWSER_E2E_OPERATING_INSTRUCTIONS.md`.
...
4. **Уровни сценариев**
   ...
   Дорожная карта PAW и визуала: `docs/artifacts/ARCH_FRONTEND_VISUAL_UNIFICATION_AND_E2E_ROADMAP.md`.
...
6. **Связь с техпаспортом:** новые маршруты в E2E дублируют канон `frontend/src/routePaths.ts` / §2 `ARCH_FRONTEND_TECH_PASSPORT_DENTAL_BOOKING.md`.
...
- `docs/artifacts/ARCH_QA_BROWSER_E2E_ENTERPRISE.md`
