...
Copyright holder / commercial licensing: **Alexandr Zaporozhan** (Russian foreign-passport / US transcription). Email mailbox stays `alexandr.zaporojan@gmail.com` (do not “correct” the local-part). Product licensing of competing clinic OS remains a separate contract, not this file.
