...
- `docs/artifacts/ARCH_REAUDIT_PLAYBOOK.md`
- `docs/artifacts/BUSINESS_LOGIC_CURRENT.md`
- `docs/artifacts/BUSINESS_LOGIC_V2.md`
...
```text
Key,Summary,Description,Assignee,Phase,Status,Labels
F1-1,F1: Обновить ARCH по доменам,"Пройти по BUSINESS_LOGIC_CURRENT и BUSINESS_LOGIC_V2, создать/обновить ARCH_*.md по доменам (Booking, CRM, ERP, Loyalty, Paperless, Tasks, Omnichannel, Marketing/Recall/Attribution).",@DOMAIN_EXPERT,F1,BACKLOG,arch,domain
