...
строго по docs/artifacts/ARCH_DEV_ERP_VITRINES_026.md и
docs/artifacts/ARCH_DEV_ERP_VITRINES_026_TASKS.md.
...
7.2.1. Описать в `docs/MIGRATION_UPGRADE.md` или кратком runbook: env-флаги, вызов POST, откат на raw.
