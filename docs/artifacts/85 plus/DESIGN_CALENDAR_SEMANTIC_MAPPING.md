...
**Источник визуала:** `docs/design/DESIGN_PALETTE_SPECTRUM_SWATCHES.html` (секция «Swiss — календарь»).  
**Токены в коде:** `frontend/src/index.css` — `var(--calendar-*)`; JSON: `docs/artifacts/85 plus/DESIGN_TOKENS_85_PLUS.json` → `color.calendar`.
