...
- После `alembic upgrade head` на staging — прогнать `EXPLAIN (ANALYZE, BUFFERS)` по запросам из `docs/artifacts/WAVE5_A3_EXPLAIN_QUERIES.sql` и зафиксировать план в тикете при необходимости.
