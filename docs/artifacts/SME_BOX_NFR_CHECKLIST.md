...
> **Назначение:** отделить **обязательные** нефункциональные требования поставки Salon/Dental Box от полного scorecard Enterprise (`docs/NONFUNCTIONAL_SCORECARD.md`).  
...
- Полный RAG pipeline для аналитики; RAG **только** в контуре бизнес-ассистента чата с клиентом — см. `docs/artifacts/PRODUCT_OPERATING_CORPUS_2026.md`.
...
- Продуктовые фазы и Enterprise-расширения: `docs/artifacts/PRODUCT_OPERATING_CORPUS_2026.md`.
