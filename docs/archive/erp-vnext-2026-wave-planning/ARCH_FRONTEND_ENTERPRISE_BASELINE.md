...
> **Вне scope:** горизонтальное масштабирование API, БД, очередей, DR, SLO бэкенда — дорожная карта `./QA_ARCH_85_PLUS_8W_EXECUTION_TRACKER.md`.
...
- Браузерный E2E (enterprise-канон, ADR-006, workflow): `./ARCH_QA_BROWSER_E2E_ENTERPRISE.md` · `./ARCH_QA_BROWSER_E2E_OPERATING_INSTRUCTIONS.md` · `docs/adr/ADR-006-playwright-browser-e2e.md` · `.github/workflows/e2e.yml`
- Визуальная унификация + PAW + уровни E2E: `./ARCH_FRONTEND_VISUAL_UNIFICATION_AND_E2E_ROADMAP.md`
- Техпаспорт фронта: `./ARCH_FRONTEND_TECH_PASSPORT_DENTAL_BOOKING.md`
- План фаз: `./ARCH_FRONTEND_TECH_PASSPORT_DEV_IMPLEMENTATION_PLAN.md`
- NFR и UI-состояния: `../../ARCHITECTURE_EXCELLENCE_PASSPORT.md` §11
- 8 недель 8.5+: краткая выжимка фронт/мост — `./QA_ARCH_85_PLUS_8W_EXECUTION_TRACKER.md` §8 · полный трекер — `./QA_ARCH_85_PLUS_8W_EXECUTION_TRACKER.md`
- Выравнивание фронта с программой 8W (отложенные эпики, `X-Request-Id` на бэкенде): `./ARCH_FRONTEND_85_PLUS_ALIGNMENT.md`

---

*Версия документа: 1.6 · ссылка на `ARCH_FRONTEND_VISUAL_UNIFICATION_AND_E2E_ROADMAP.md` (PAW, indigo/Inter, уровни E2E); зафиксировано закрытие фаз **0–5** техплана (TanStack Query §5, `queryKeys`, доработки @QA_ARCH v1.6.5), плюс база **0–4** (§4 баррели + CI-паритет), усиление HTTP-моста v1.5.3 (@QA_ARCH 2026-03); ссылка на `ARCH_FRONTEND_85_PLUS_ALIGNMENT.md`.*
