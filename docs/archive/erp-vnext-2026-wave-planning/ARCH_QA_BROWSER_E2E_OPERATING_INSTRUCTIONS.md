...
> **Канон стратегии:** `./ARCH_QA_BROWSER_E2E_ENTERPRISE.md`  
> **ADR:** `docs/adr/ADR-006-playwright-browser-e2e.md`  
> **Визуал + PAW + уровни E2E:** `./ARCH_FRONTEND_VISUAL_UNIFICATION_AND_E2E_ROADMAP.md`
...
4. **Смена темы / дизайн‑токены:** не привязываться к классам Mantine (`.mantine-Button-root`) и к цвету в CSS; для регрессий после смены палитры — см. §6 `./ARCH_FRONTEND_DESIGN_SYSTEM_MIDNIGHT.md` (роли, `getByRole`, `data-testid`).
