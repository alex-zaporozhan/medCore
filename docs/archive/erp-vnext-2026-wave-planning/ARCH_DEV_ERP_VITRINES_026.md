...
**Документация:** `../../MIGRATION_UPGRADE.md` (ERP витрины + права refresh), §6 `ARCH_PERF_ENGINE_L2_DEEP_2026.md`. Детальный чеклист фаз и G1–G5 — `ARCH_DEV_ERP_VITRINES_026_TASKS.md`.
