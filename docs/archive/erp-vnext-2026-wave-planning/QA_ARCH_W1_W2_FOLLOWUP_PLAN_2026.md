...
|---|-------------|----------|
| 1 | `NONFUNCTIONAL_AUDIT_NEXT.md` | Файл **`./NONFUNCTIONAL_AUDIT_NEXT.md`** поддерживается (§5 ERP L2, §6 пороги / кардинальность / runbook / Grafana / SLO); перекрёстные ссылки на `deploy/prometheus/dental_booking_alerts.yml` и подвал «Связанные артефакты» ↔ этот план. |
...
| 3 | `../../MIGRATION_UPGRADE.md` | Параграф: ревизия **`q3r4s5t6u7v8`** (watermark), флаги **`ERP_AGGREGATE_EVENT_*`**, порядок деплоя с Celery/Redis. |
